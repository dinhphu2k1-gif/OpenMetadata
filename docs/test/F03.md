...
| F01-UI-01 | Consumer-only mở Data Dictionary không có query param | Hiển thị bản Approved mới nhất ở chế độ chỉ đọc; không có action mutation |
...
| F05-UI-01 | Reviewer phê duyệt CDE InReview | Chuyển sang Approved chỉ đọc; Consumer đọc được snapshot |
...
| F06-UI-03 | Consumer mở CDE khi version mới chưa Approved | Vẫn xem bản Approved trước đó; không thấy version mới |
