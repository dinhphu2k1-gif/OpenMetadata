...
# Paths
TAR_FILE="openmetadata-dist/target/openmetadata-1.13.0.tar.gz"
...
JAR_FILE="$TMP_BUILD/openmetadata-1.13.0/libs/openmetadata-ui-1.13.0.jar"
if [ ! -f "$JAR_FILE" ]; then
...
cd "$TMP_BUILD"
tar czf /home/dinhphu/Documents/openmetadata/OpenMetadata/$TAR_FILE openmetadata-1.13.0/
