...
CREATE TABLE IF NOT EXISTS `glossary_business_working` (
  ...
  `createdBy` varchar(256) NOT NULL, `updatedAt` bigint unsigned NOT NULL,
  `updatedBy` varchar(256) NOT NULL, `submittedAt` bigint unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `glossary_business_snapshot` (
  ...
  `publishedBy` varchar(256) NOT NULL, `archivedAt` bigint unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `glossary_snapshot_outbox` (
  `eventId` varchar(36) NOT NULL, `snapshotId` varchar(36) NOT NULL,
  `eventType` varchar(64) NOT NULL, `payload` json NOT NULL,
  `createdAt` bigint unsigned NOT NULL, `processedAt` bigint unsigned DEFAULT NULL,
