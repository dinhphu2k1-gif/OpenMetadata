...
export interface Glossary {
  /** Business-facing version of this working version or published snapshot. */
   ...
   */
  termCount?: number;
  /** Exact glossary term revisions included in this snapshot. */
   ...
   */
  version?: number;
  /** Optimistic-lock revision of the working version. */
  workingRevision?: number;
  /** Identifier of the immutable published snapshot. */
  snapshotId?: string;
  ...
  archivedBy?: string;
  /** Versioning model used by this glossary. */
