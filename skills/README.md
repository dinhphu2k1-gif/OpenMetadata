...
| [OpenMetadata UI Feature](openmetadata-ui-feature/SKILL.md) | `$openmetadata-ui-feature` | Implement UI changes with scope-aware patterns, tests, and verification |
